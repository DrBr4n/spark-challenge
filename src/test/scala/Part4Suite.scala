...
class Part4Suite extends AnyFunSuite with SharedSparkSessionHelper {
  ...
  test ("Assert that part4 joins the data frames correctly") {
    ...
    val expected = Seq(
      ...
      ("Bar", categories,"4.5", "20", "1.5625", "2000+", "Paid", "$6.0", "Everyone", "Family", "June 10, 2020", "2.0.0", "3.0.0 and up", "0.0"))
      .toDF("App", "Categories", "Rating", "Reviews", "Size",
        "Installs", "Type", "Price", "Content_Rating", "Genres",
